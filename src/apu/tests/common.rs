...
pub(super) struct ApuTestDebugState {
    ...
    pub(super) wave_ram_access_open: bool,
    pub(super) wave_ram_last_read_byte_index: u8,
...
impl ApuHarness {
    ...
    pub(super) fn apu_test_state(&self) -> ApuTestDebugState {
        ApuTestDebugState {
            ...
            wave_ram_access_open: self.apu.wave.wave_ram_access_open,
            wave_ram_last_read_byte_index: self.apu.wave.wave_ram_last_read_byte_index,
