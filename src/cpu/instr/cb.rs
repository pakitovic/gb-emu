...
impl Cpu {
    pub(in crate::cpu) fn read_r8_by_index(&mut self, idx: u8, bus: &mut impl CpuContext) -> u8 {
        match idx {
            0 => self.registers.b,
            1 => self.registers.c,
            2 => self.registers.d,
    ...
    pub(in crate::cpu) fn write_r8_by_index(
        &mut self,
        idx: u8,
        value: u8,
    ...
    pub(in crate::cpu) fn execute_cb(&mut self, bus: &mut impl CpuContext) -> u8 {
