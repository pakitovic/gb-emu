...
use super::video::VideoPaletteSelection;
...
impl WebEmulator {
    pub(super) fn new_internal(
        ...
        let default_video_palette = VideoPalette::auto_base_for_model(model);
        ...
        Ok(Self {
            ...
            video_palette_selection: VideoPaletteSelection::Auto,
